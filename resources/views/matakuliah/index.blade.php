...
<body>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-12" style="margin-top: 2%">
                <a href="{{ route('dosen.index') }}" class="btn btn-primary">Data Dosen</a>
                &nbsp;
                <a href="{{ route('mahasiswa.index') }}" class="btn btn-success">Data Mahasiswa</a>
                &nbsp;
                <a href="{{ route('prodi.index') }}" class="btn btn-info">Data Prodi</a>
            </div>
            <div class="col-md-12">
